...
pub fn build(state: AppState) -> Router {
    Router::new()
        ...
        .route("/arsenals/sepulchre", get(routes::sepulchre::list))
        .route(
            "/arsenals/sepulchre/connections/new",
            get(routes::sepulchre::new_connection_form),
        )
        .route(
            "/arsenals/sepulchre/connections",
            post(routes::sepulchre::create_connection),
        )
        .route(
            "/arsenals/sepulchre/connections/:id",
            get(routes::sepulchre::connection_detail),
        )
        .route(
            "/arsenals/sepulchre/connections/:id/roles",
            post(routes::sepulchre::update_roles),
        )
        .route(
            "/arsenals/sepulchre/connections/:id/validate",
            post(routes::sepulchre::validate_connection),
        )
        .route(
            "/arsenals/sepulchre/connections/:id/host-key",
            get(routes::sepulchre::probe_host_key_form).post(routes::sepulchre::confirm_host_key),
        )
        .route(
            "/arsenals/sepulchre/connections/:id/secret",
            post(routes::sepulchre::replace_secret),
        )
        .route(
            "/arsenals/sepulchre/connections/:id/delete/confirm",
            get(routes::sepulchre::delete_connection_confirm),
        )
        .route(
            "/arsenals/sepulchre/connections/:id/delete",
            post(routes::sepulchre::delete_connection),
        )
        .route(
            "/arsenals/sepulchre/hosts/:host_id",
            get(routes::sepulchre::show_host),
        )
        .route(
            "/arsenals/sepulchre/hosts/:host_id/detect-backend",
            post(routes::sepulchre::detect_host_backend),
        )
        .route(
            "/arsenals/sepulchre/hosts/:host_id/shares/new",
            get(routes::sepulchre::new_share_form),
        )
        .route(
            "/arsenals/sepulchre/hosts/:host_id/shares",
            post(routes::sepulchre::create_share),
        )
        .route(
            "/arsenals/sepulchre/hosts/:host_id/shares/:share_id/delete/confirm",
            get(routes::sepulchre::delete_share_confirm),
        )
        .route(
            "/arsenals/sepulchre/hosts/:host_id/shares/:share_id/delete",
            post(routes::sepulchre::delete_share),
        )
        .route(
            "/arsenals/sepulchre/hosts/:host_id/mounts/new",
            get(routes::sepulchre::new_mount_form),
        )
        .route(
            "/arsenals/sepulchre/hosts/:host_id/mounts",
            post(routes::sepulchre::create_mount),
        )
        .route(
            "/arsenals/sepulchre/hosts/:host_id/mounts/:mount_id/delete/confirm",
            get(routes::sepulchre::delete_mount_confirm),
        )
        .route(
            "/arsenals/sepulchre/hosts/:host_id/mounts/:mount_id/delete",
        ...
        .route(
            "/arsenals/panopticon/subnets/rederive",
            post(routes::panopticon::subnets_rederive),
        )
        .route(
